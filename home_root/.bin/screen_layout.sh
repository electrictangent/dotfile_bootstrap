#!/usr/bin/env bash
#
# Use rofi/zenity to change screenlayout
#
...
ROFI_TEXT="   "
ROFI_OPTIONS=(-lines 100)
ROFI_OPTIONS=(-width 500 -padding 10)
...
menu=(
  [	Single]="~/.screenlayout/single_layout.sh"
  [	Duplicate]="~/.screenlayout/duplicate_layout.sh"
  [	Extended]="~/.screenlayout/dual_layout.sh"
)
#menu_nrows=${#menu[@]}
menu_nrows=10
# Menu entries that may trigger a confirmation message
menu_confirm="Single Duplicate Extended"
